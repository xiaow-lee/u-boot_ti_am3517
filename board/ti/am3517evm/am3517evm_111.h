...
#define MUX_AM3517EVM() \
	...
	\
	MUX_VAL(CP(MMC2_CLK),		( IDIS | PTU | EN  | M4)) /*USB0_ID*/\
	MUX_VAL(CP(MMC2_CMD),		(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(MMC2_DAT0),		( IDIS | PTU | EN  | M4)) /*EN_VBAT*/\
	MUX_VAL(CP(MMC2_DAT1),		( IDIS | PTU | EN  | M4)) /*EN_ADAP*/\
	MUX_VAL(CP(MMC2_DAT4),		( IDIS | PTU | EN  | M4)) /*EN_VBUS*/\
	MUX_VAL(CP(MMC2_DAT2),		( IDIS | PTU | EN  | M4)) /*EN_VPSYS*/\
	MUX_VAL(CP(MMC2_DAT3),		(IEN  | PTU | EN | M4)) /*USB_INT*/\
	/* McBSP */\
	...
	\
	/*KEY for VC754*/\
	MUX_VAL(CP(MCBSP2_FSX),		(IEN  | PTU | EN | M4)) /*PK1*/\
	MUX_VAL(CP(MCBSP2_CLKX),	(IEN  | PTU | EN | M4)) /*RTC_IRQ*/\
	MUX_VAL(CP(MCBSP2_DR),		(IEN  | PTU | EN | M4)) /*PK3*/\
	MUX_VAL(CP(MCBSP2_DX),		(IEN  | PTU | EN | M4)) /*PK2*/\
	MUX_VAL(CP(SYS_CLKOUT1),	(IEN  | PTU | EN | M4)) /*PKON*/\
	MUX_VAL(CP(CCDC_DATA3),		(IEN  | PTD | DIS | M0))/*EN_AUDIO   Disable*/\
	\
	MUX_VAL(CP(MCBSP3_DX),		( IDIS | PTU | EN  | M4)) /*PK_OFF*/\
	MUX_VAL(CP(MCBSP3_DR),		(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(MCBSP3_CLKX),	(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(MCBSP3_FSX),		(IEN  | PTU | EN | M4)) /*ADAP_INT*/\
	\
	MUX_VAL(CP(MCBSP4_CLKX),	(IEN  | PTU | EN | M4)) /*M_SDRDYB*/\
							 /* - LCD_INI*/\
	MUX_VAL(CP(MCBSP4_DR),		( IDIS | PTU | EN  | M4)) /*M_SRST*/\
							 /* - LCD_ENVDD */\
	MUX_VAL(CP(MCBSP4_DX),		(IEN  | PTU | EN | M4)) /*M_SDRDYA*/\
							 /* - LCD_QVGA/nVGA */\
	MUX_VAL(CP(MCBSP4_FSX),		( IDIS | PTU | EN  | M4)) /*M_STRIGB*/\
							 /* - LCD_RESB */\
	/* UART */\
	MUX_VAL(CP(UART1_TX),		(IDIS | PTD | DIS | M0)) \
	MUX_VAL(CP(UART1_RTS),		(IEN  | PTU | EN | M4)) /*CHRG_INT*/\
	MUX_VAL(CP(UART1_CTS),		(IEN  | PTU | EN | M4)) /*FAULT_INT*/\
	\
	MUX_VAL(CP(UART1_RX),		(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(UART2_CTS),		(IEN  | PTU | EN | M4)) /*HOCD*/\
	MUX_VAL(CP(UART2_RTS),		( IDIS | PTU | EN  | M4)) /*HRTS*/\
	MUX_VAL(CP(UART2_TX),		(IDIS | PTD | DIS | M0)) /*HTX2*/\
	MUX_VAL(CP(UART2_RX),		(IEN  | PTD | DIS | M0)) /*HR2*/\
	\
	...
	MUX_VAL(CP(MCSPI1_CS1),		( IDIS | PTU | EN  | M4)) /*M_SEN*/\
	MUX_VAL(CP(MCSPI1_CS2),		(IEN  | PTU | DIS | M4)) /*M_STRIGA*/\
							 /* - LAN_INTR*/\
	...
	/* CCDC */\
	MUX_VAL(CP(CCDC_PCLK),		( IDIS | PTU | EN  | M4)) /*PPMVA+5*/\
	MUX_VAL(CP(CCDC_FIELD),		( IDIS | PTU | EN  | M4)) /*M_MTRIGB*/\
	MUX_VAL(CP(CCDC_HD),		( IDIS | PTU | EN  | M4)) /*PPMVA+24*/\
	MUX_VAL(CP(CCDC_VD),		( IDIS | PTU | EN  | M4)) \
	MUX_VAL(CP(CCDC_WEN),		( IDIS | PTU | EN  | M4)) /*PPSVA+5*/\
	MUX_VAL(CP(CCDC_DATA0),		(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(CCDC_DATA1),		(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(CCDC_DATA2),		(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(CCDC_DATA4),		(IEN  | PTU | EN  | M4)) \
	MUX_VAL(CP(CCDC_DATA5),		(IEN  | PTU | EN | M4))/*M_MDRDYA*/\
	MUX_VAL(CP(CCDC_DATA6),		(IEN  | PTU | EN | M4)) /*M_MDRDYB*/\
	MUX_VAL(CP(CCDC_DATA7),		( IDIS | PTU | EN  | M4)) /*M_MEN*/\
	/* RMII */\
	...
	/* HECC */\
	MUX_VAL(CP(HECC1_TXD),		( IDIS | PTU | EN  | M4)) /*M_MRST*/\
	MUX_VAL(CP(HECC1_RXD),		( IDIS | PTU | EN  | M4)) /*M_MTRIGA*/\
	/* HSUSB */\
